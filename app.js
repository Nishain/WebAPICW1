...
//app.use('/ping/',require('./end-points/ping/pingRoute'))
app.use('/users/',require('./end-points/users/usersRoute'))
app.use('/products/',require('./end-points/products/productRoute'))
// app.use('/invoice',require('./end-points/Admin/invoice/invoice'))
// app.use('/productView',require('./end-points/Admin/Category/category'))
// app.use('/cart',require('./end-points/addToCart'))
