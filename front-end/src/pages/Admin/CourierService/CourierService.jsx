...
import {
  CourierServiceTypes,
  CourierServiceValue,
} from "./extranalCourierServiceData";
...
export default function CourierService() {
  ...
  const addCourierService = async () => {
    ...
    const result = await axios.post(
      "http://localhost:5000/Admin/courierservice",
      values
    );
    ...
    <div className="container">
        ...
        <div className="col-md-4">
          <div className="form-group">
            ...
            <Input
              ...
              value={valueCourierService}
              onChange={changeCourierService(
                CourierServiceTypes.CourierServiceType
              )}
            />
          </div>
        </div>
      ...
      <div className="row">
        ...
        <div className="col-12">
          <Button type="primary" onClick={addCourierService}>
            Add Courier Service
          </Button>
        </div>
      </div>
