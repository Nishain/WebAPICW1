                        ...
                        <div className="col-12 col-lg-10 offset-lg-1">
                            ...
                            <div className="mt-4">
                                <div className="row text-600 text-white bgc-default-tp1 py-25">
                                    ...
                                    <div className="col-9 col-sm-3">Photo</div>
                                    <div className="d-none d-sm-block col-4 col-sm-2">Size</div>
                                    <div className="d-none d-sm-block col-4 col-sm-2">Unit Price</div>
                                    <div className="d-none d-sm-block col-sm-2">Qty</div>
